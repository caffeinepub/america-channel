...
import type { UserProfile as _UserProfile, UserRole as _UserRole, Video as _Video } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async dislikeVideo(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.dislikeVideo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChannel(): Promise<Channel> {
        if (this.processError) {
            try {
                const result = await this.actor.getChannel();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async subscribe(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.subscribe();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateChannel(arg0: Channel): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateVideo(arg0: bigint, arg1: Video): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateVideo(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Video]): Video | null {
    return value.length === 0 ? null : value[0];
}
